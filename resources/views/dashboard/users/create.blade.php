...
if(field2 == "")
{
document.getElementById('xfield2').innerHTML = " <b style='font-size:17px; font-weight:bold;  color:#f00;'> {{__('lang.Valid')}} </b>";
...
<form action="{{route('registration.post')}}" method="POST"  onsubmit="return save()">
@csrf
