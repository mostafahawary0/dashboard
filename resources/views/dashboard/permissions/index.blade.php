...
<li class="active" style="padding-left:10px; padding-right:10px;"> {{__('lang.permissions')}} / </li>
              ...
              <div class="col-lg-12">
                <div class="card mb-0">
                  <div class="card-header" style="{{__('lang.rtl')}}">
                    <div> <b> {{__('lang.permissions')}}  </b> </div>
                  </div>
                  <div class="card-body pt-0">
                    <div class="table-responsive">
                      ...
                      <table class="table mb-0 table-striped">
                        <thead>
                          <tr>
                            <th>{{__('lang.NPermissionsAR')}} </th>
                            <th>{{__('lang.NPermissionsEN')}} </th>
                            <th>{{__('lang.NPermissionsFR')}} </th>
...
<tr>
<td style="font-size:18px">{{$section->permissionsAR}}</td>
<td style="font-size:18px">{{$section->permissionsEN}}</td>
<td style="font-size:18px">{{$section->permissionsFR}}</td>
<td style=" text-align:center;">
<a href="{{route('permissions.edit',$section->uuid)}}" type="button" class="btn btn-primary" style="font-size:14px;">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="{{route('permissions.destroy',$section->uuid)}}" method="post">
          @method('DELETE')
          @csrf
